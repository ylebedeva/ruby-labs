...
describe "Module #4: Navigation Tests", :type => :routing do
    ...
    context "rq05" do
        ...
        context "rq05b" do
            ...
            scenario "TodoList show page displays associated todo_items", :skip => true do
        ...
        context "rq05d" do
            ...
            scenario "TodoItem endpoint is accessible (show and destroy) through TodoList", :skip => true do
                tl_id = TodoList.all.sample.id
                list_items = TodoList.find(tl_id).todo_items
        ...
        context "rq05e" do
            ...
            scenario "TodoList page has new TodoItem link with specified URI and method", :skip => true do
                tl_id = TodoList.all.sample.id
